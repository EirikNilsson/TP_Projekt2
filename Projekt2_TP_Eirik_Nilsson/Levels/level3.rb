...
set width: 800
set height: 600
set background: Image.new('background3.png',
width: Window.width,
  ...
  if start 
    ...
    if alive 
      if score < 50
        ...
        if enemy1.width == 292 or enemy2.width == 292 or enemy3.width == 300
          alive = false
        end
            ...
            on :mouse_up do |event|
              ...
              when :left
                ...
                if circle && lobby_hit?(lobby, circle)
                  ...
                  update do
                    require 'C:\Users\eirik.haugennilsson\Desktop\Tillämpad_Programering\Projekt2_TP_Eirik_Nilsson\Main_lobby\finish_main.rb'
                  end
